...
class Game:
	def __init__(self, store, stage, inventory, bank, rerollStore, turnCounter):
...
class Button():
	...
	def show(self, text):
		...
		self.displayText(smallFont, False, text, BLACK, self.x, self.y)
...
def main():
	...
	turnCounter = TurnCounter(WINDOWWIDTH * .75 - 230*0.5, 0, 230, 50)
